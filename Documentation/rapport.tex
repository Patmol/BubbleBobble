...
Cette section d\'ecrira les différents \'el\'ements pour le fonctionnement du jeu, \`a savoir comment le monde est repr\'esent\'e ou comment la d\'etection entre deux \'el\'ements du jeu sera faite.
...
Les fichiers des niveaux seront g\'en\'er\'e par le programme au lancement de celui-ci si ceux-ci n'existent pas. Dans les versions suivantes du jeu, il sera possible via une interface de créer des niveaux directement dans le jeu afin de faciliter leur cr\'eation.
